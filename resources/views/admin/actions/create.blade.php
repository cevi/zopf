        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    @endif
                    <div class="form-group">
                        {!! Form::label('addGroupUsers', 'Personen der Gruppe auf Aktion übernehmen:', ['class' =>'block mb-2 text-sm font-medium text-gray-900 dark:text-white']) !!}
                        {!! Form::checkbox('addGroupUsers', '1', false, ['class' => 'mb-6 bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500']) !!}
